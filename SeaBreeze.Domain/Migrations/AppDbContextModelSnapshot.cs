...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Payment.PayriffOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.RealEsstates.FeatureRealEstate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.RealEsstates.FeatureRealEstate", b =>
                {
                    b.HasOne("SeaBreeze.Domain.Entity.RealEsstates.Feature", "Feature")
                        .WithMany()
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SeaBreeze.Domain.Entity.RealEsstates.RealEstate", "RealEstate")
                        .WithMany("FeatureRealEstates")
                        .HasForeignKey("RealEstateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Tickets.BeachClubOrder", b =>
                {
                    ...
                    b.HasOne("SeaBreeze.Domain.Entity.Payment.PayriffOrder", "PayriffOrder")
                        .WithMany()
                        .HasForeignKey("PayriffOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppUser");

                    b.Navigation("PayriffOrder");
                });
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.RealEsstates.RealEstate", b =>
                {
                    b.Navigation("FeatureRealEstates");
